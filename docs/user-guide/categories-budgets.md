...
- Create subcategories with prefixes (e.g., "Food - Groceries", "Food - Dining")
- Review and consolidate periodically

**Don't:**
- Create too many narrow categories
- Use vague names like "Stuff" or "Things"
- Duplicate similar categories
- Delete categories with active transactions
