...
class Transaction(db.Model):
    ...
    Attributes:
        ...
        account_id (int): Foreign key referencing the account of the transaction.
    ...
    account_id = db.Column(db.Integer, db.ForeignKey("accounts.id"), nullable=False)  # Associated account ID.
    ...
    account = db.relationship("Account", backref="transactions")  # Relationship to Account model.
