...
class TestAddTransactionService(unittest.TestCase):
    ...
    @patch("app.services.transactions.add_transaction.Account")
    @patch("app.services.transactions.add_transaction.flash")
    def test_render_add_transaction_form_success(self, mock_flash, mock_account, mock_category,
    ...
    @patch("app.services.transactions.add_transaction.Account")
    @patch("app.services.transactions.add_transaction.flash")
    def test_render_add_transaction_form_failure(self, mock_flash, mock_account, mock_category,
